          ...
          <AnimatePresence>
            {activeIndex === idx && (
              <motion.div
                ...
                className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 z-20 px-3 py-1 bg-gray-800 text-white text-sm rounded shadow-lg pointer-events-none select-none whitespace-pre-line max-w-xs text-center"
